...
源码仓库不在这里公开。本仓库只提供安装包、版本说明和图文使用文档。
...
- 项目文件夹管理：统一管理项目设置、脚本、文件夹和交付归档。
- 文件夹素材约定：自动识别 `6.导出/发布视频.*`、`7.封面/16-9.*`、`7.封面/4-3.*`。
- 临时手动导入：未绑定项目文件夹时，可临时导入视频和封面；临时素材不写入 `.flash`。
- 三平台分发：抖音、小红书接入 social-auto-upload 发布内核；YouTube 入口保留，等待官方 API 账号配置。
...
| 版本 | SHA256 |
| --- | --- |
| 1.2.2 | `c1809a5c3ccb633b7de3f1b8c9a22b6f948ea8ab906b33e775b889691245b57f` |
| 1.2.1 | `d61b974136ae2543074985dba8bbcc1e0ae05d91bfcb6abe4b5951c6ecaad84c` |
